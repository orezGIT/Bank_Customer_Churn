...
#%%
# Save RAW data 
merged_df.to_csv('raw_data.csv', index=False)  # Original columns
...
merged_df = merged_df.drop(['TransactionID', 'TransactionDate', 'InteractionID',
                            'InteractionDate', 'InteractionType', 'ResolutionStatus', 'LastLoginDate'], axis=1) 

merged_df                              
#%%
# Save PROCESSED DATA (after feature engineering + dropping columns)
